...
```{r carpeta-codigos1, echo = FALSE, out.width = "50%", fig.align = "center", fig.cap = "Creamos un fichero «variables.R»."}
knitr::include_graphics("./img/carpeta_codigos1.jpg")
```
...
<details>
  <summary><strong>Comentarios en los códigos</strong></summary>
...
<details>
  <summary><strong>Limpiar el entorno</strong></summary>
...
<details>
  <summary><strong>Anular warnings</strong></summary>
...
<details>
  <summary><strong>Limpiar consola</strong></summary>
...
<details>
  <summary><strong>Guardar los scripts</strong></summary>
...
<details>
  <summary><strong>Fecha y hora de hoy</strong></summary>
...
<details>
  <summary><strong>Cambiar la notación exponencial</strong></summary>
