...
* \@ref(procesamiento) [Introducción al procesamiento de datos](#procesamiento)
...
En los **`r colorize("recuadros rojos", "#dc3545")`** encontrarás **errores comunes** o prácticas a evitar.
