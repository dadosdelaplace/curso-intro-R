...
- \usepackage{caption}
description: "Introducción a R desde cero. Curso elaborado por Javier Álvarez Liébana"
...
* \@ref(otros-datos) [Otros datos: listas y factores](#otros-datos)
* \@ref(funciones) [Creación de funciones](#funciones)
* \@ref(resumen-1) [Alto en el camino: ¿qué sabemos hacer?](#resumen-1) 
* \@ref(tidydata) [Tidy data: ordenando datos](#tidydata)   
* \@ref(tidyverse) [Explorando los datos: incursión a tidyverse](#tidyverse)
...
Además de **investigador** (con plaza y acreditación de Ayudante Doctor en la Facultad de Estudios Estadísticos de la Universidad Complutense de Madrid, tras ocupar dicha plaza en la Universidad de Oviedo), soy [**docente** en dicha facultad](#docencia-impartida) y ando intentando eso de la **divulgación en estadística y dataviz** (visualización de datos) en redes sociales
