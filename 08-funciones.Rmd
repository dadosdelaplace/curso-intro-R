...
```{r include = FALSE}
load("~/Dropbox/DIVULGACIÓN/CURSO R BIOQUIMICA EN MOVIMIENTO/CURSO R/curso_R/DATOS/panel_vacunas_ccaa.RData") 
load("~/Dropbox/DIVULGACIÓN/CURSO R BIOQUIMICA EN MOVIMIENTO/CURSO R/curso_R/DATOS/panel_vacunas_fecha.RData")
```
