# Tipos de datos II: tablas {#datos}
...
<details>
  <summary>Acceso a librería</strong></summary>
...
<details>
  <summary>Nombre de variables</strong></summary>
...
<details>
  <summary>Paquete `{tibble}`</strong></summary>
...
<details>
  <summary><strong>Ejercicio 1</strong>: define una matriz de ceros de 3 filas y 7 columnas. Tras hacerlo calcula su transpuesta y obtén sus dimensiones</summary>
...
<details>
  <summary><strong>Ejercicio 2</strong>: calcula la suma de cada fila de la matriz `matriz <- matrix(1:12, nrow = 4)` usando un bucle. Haz lo mismo evitando usar bucles.</summary>
...
```{r include = FALSE}
vacunas_esp <- read.csv(file = "~/Dropbox/DIVULGACIÓN/CURSO R BIOQUIMICA EN MOVIMIENTO/CURSO R/curso_R/DATOS/datos_ES.csv")
```
...
```{r include = FALSE}
vacunas_esp <- read.csv(file = "~/Dropbox/DIVULGACIÓN/CURSO R BIOQUIMICA EN MOVIMIENTO/CURSO R/curso_R/DATOS/datos_ES.csv", sep = ",", dec = ".", header = TRUE)
```
...
<details>
  <summary>Paquetes `{readr}` y `{tidyr}`</strong></summary>
  
En dichos paquetes tienes más funciones para una **fácil exportación y tabulación de distintos tipos de datos**, sea el formato que sea. Ver <https://tidyr.tidyverse.org/> y <https://readr.tidyverse.org/>
...
<details>
  <summary>Paquete `{rvest}`</strong></summary>
...
<details>
  <summary>Secciones en el código</strong></summary>
...
<details>
  <summary>Líneas de código en los errores</strong></summary>
...
<details>
  <summary>Margen derecho en la ventana de scripts</strong></summary>
